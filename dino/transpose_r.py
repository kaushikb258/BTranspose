...
class TransPoseR_alpha(nn.Module):
    ...
    def __init__(self, block, layers, w, h, pos_embedding_type, n_head, encoder_layers_num, dim_feedforward, d_model):
        ...
        self.layer3 = self._make_layer(block, 256, layers[2], stride=1, heads=4, mhsa=True, resolution=[32,24])
        # NOTE: RESNET USES 64, 128, 256
    ...
    def forward(self, x):
        ...
        # KAUSHIK: WE NEED THE FOLLOWING LINE TO SEND 1D REPRESENTATION TO DINOHEAD 
        x = torch.flatten(x, 1) 
